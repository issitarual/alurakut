  ...
  return (
    <AlurakutMenu.Wrapper isMenuOpen={isMenuOpen} theme={theme? '#D9E6F6' : '#22272E'} isDark={theme}>
      <div className="container">
        ...
        <nav style={{ flex: 1 }}>
          {[{ name: 'Inicio', slug: '/'}, { name: 'Perfil', slug: `/profile/`}, { name: 'Página de recados', slug: `/scraps/${githubUser}`}, {name: 'Amigos', slug: `/friends/${githubUser}`}, {name: 'Comunidades', slug: `/communities/${githubUser}`}].map((menuItem) => (
